...
parser.add_argument('--max_resolution', type=int, default=256,required=False, help='max_resolution(of a photo)')
parser.add_argument('--min_resolution', type=int, default=512,required=False, help='min_resolution(of a photo)')
