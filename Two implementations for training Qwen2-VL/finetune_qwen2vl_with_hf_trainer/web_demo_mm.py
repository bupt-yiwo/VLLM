...
DEFAULT_CKPT_PATH = '/home/zhuyao/Sunpeng/A100_QWEN2VL/result/visual/1_0_visual1_28-31_3/step-200'
...
def _load_model_processor(args):
    ...
    if args.flash_attn2:
        ...
        model = Qwen2VLForConditionalGeneration.from_pretrained(args.checkpoint_path, device_map='cuda')
    from peft import PeftModel, PeftConfig
    # peft_config = PeftConfig.from_pretrained("/home/zhuyao/Sunpeng/A100_QWEN2VL/result/downstream/1_0_1_3")
    # model = PeftModel.from_pretrained(model, "/home/zhuyao/Sunpeng/A100_QWEN2VL/result/downstream/1_0_1_3")  
...
def _launch_demo(args, model, processor):
    ...
    def call_local_model(model, processor, messages):
        ...
        gen_kwargs = {'max_new_tokens': 1000, 'streamer': streamer, **inputs}
