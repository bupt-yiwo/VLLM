...
num_training_steps = math.floor(num_epochs * len(train_dataloader) /  (args.per_device_train_batch_size * args.gradient_accumulation_steps))
...
for epoch in range(num_epochs):
    ...
    if accelerator.is_main_process: 
        save_path = os.path.join(args.output_dir, f"step-4105")
        model.save_pretrained(save_path)
