...
processor = AutoProcessor.from_pretrained("/home/zhuyao/Sunpeng/models/qwen_2B_instruct")
...
with open("/home/zhuyao/Sunpeng/wxx_data_eval/data/11.5/results/qwen2vl_2B.json",'w') as f :
