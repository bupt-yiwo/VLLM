...
class MiniCPMV(MiniCPMVPreTrainedModel):
    ...
    def _decode(self, inputs_embeds, tokenizer, **kwargs):
        ...
        return self._decode_text(output.sequences, tokenizer),output.scores[0][0]
    ...
    def generate(
        ...
        **kwargs
        ...
        with torch.inference_mode():
            ...
            result,F1 = self._decode(model_inputs["inputs_embeds"], tokenizer, **kwargs)

        if return_vision_hidden_states:
            return result, vision_hidden_states,F1
    ...
    def chat(
        ...
        **kwargs
        ...
        with torch.inference_mode():
            res, vision_hidden_states,F1 = self.generate(
        ...
        return answer, context, generation_config,F1
