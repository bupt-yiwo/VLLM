...
import sys
sys.path.append("/home/zhuyao/Sunpeng/MLLMs/4-10B/internvl2_8B")
...
path = '/home/zhuyao/Sunpeng/MLLMs/0-4B/InternVL2_2B'
...
def custom_chat(self, tokenizer, pixel_values, question, generation_config, history=None, return_history=False,
        ...
        if return_history:
            ...
            return response,generation_output.scores[0][0]
...
for dp in tqdm(data, desc="Processing"):
    with torch.no_grad():
        ...
        logits_yn = [logitsf1[9583],logitsf1[2917],logitsf1[9828],logitsf1[2305]]
...
with open("/home/zhuyao/Sunpeng/wxx_data_eval/data/11.5/results/InternVL2_8B.json",'w') as f :
